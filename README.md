...
1. **Configure Settings**
   Upon startup, you may want to adjust your settings for optimal performance. Select your preferred language from the options menu.

2. **Begin Speech Recognition**
   To start transcription, click on the "Start" button. Speak clearly into your microphone and watch the text appear in real-time.

3. **Saving Transcriptions**
   After your session, you can save your transcript by clicking on "Save." Choose your desired format (e.g., TXT, DOCX).

### 🌍 Multi-Language Support
whisperlivekit-enhanced supports multiple languages. You can easily switch languages in the settings menu. Current supported languages include English, Spanish, French, German, and more.

### 🔌 Advanced Features

- **Lazy Loading:** This feature optimizes resource usage and speeds up the application, making it lightweight and responsive.
- **Auto Resource Release:** The app intelligently manages GPU resources, freeing them up when they’re not needed.
- **Real-Time Transcription:** Conversion occurs as you speak, with minimal delay.

### 📝 Tips for Best Performance
- Ensure you have a quiet environment for clear audio input.
- Use a high-quality microphone for the best results.
